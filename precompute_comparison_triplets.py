...
def remove_intersection_if_necessary_to(from_triplets,to_triplets,descendants_species,descendants_organ,descendants_disease):#
    if (descendants_species=='from_descendants_of_to' or descendants_organ=='from_descendants_of_to' or descendants_disease=='from_descendants_of_to'):
...
def remove_intersection_if_necessary_from(from_triplets,to_triplets,descendants_species,descendants_organ,descendants_disease):#
    if (descendants_species=='to_descendants_of_from' or descendants_organ=='to_descendants_of_from' or descendants_disease=='to_descendants_of_from'):
