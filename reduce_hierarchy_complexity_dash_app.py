#binvestigate_heroku is a good environment
...
min_fold_change=sys.argv[2]


if sys.argv[1]=='compound':
    annotation_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/compound_list.csv'
    json_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/cyto_compounds.json'
elif sys.argv[1]=='species':
    annotation_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/species_list.csv'
    json_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/cyto_species.json'
elif sys.argv[1]=='organ':
    annotation_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/organ_list.csv'
    json_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/cyto_organ.json'
elif sys.argv[1]=='disease':
    annotation_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/disease_list.csv'
    json_address=f'../../results/{min_fold_change}/step_14_reduce_hierarchy_complexity_pre_dash/cyto_disease.json'
